...
const shpLength = (
  ...
  if (typeString === "PolygonM") polyline_record_length_bytes += features.length += 16 + coordinates.length * 8;
  if (typeString === "PolygonZ") polyline_record_length_bytes += features.length += 32 + coordinates.length * 16;
